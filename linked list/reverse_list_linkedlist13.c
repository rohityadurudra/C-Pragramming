...
// Reverse function with an additional parameter to store the original head
// void reverse_list(struct node** head, struct node** old_head) {
//     *old_head = *head; // Store the original head before reversing
